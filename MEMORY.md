...
- **2026-08-20 v0.16.1 RELEASE.** i18n patch on top of companion-tools. 0.16.0 MSI still showed `nav.hotWorlds` as a raw key and English Hot Worlds copy under zh-CN; 0.16.1 ships 7-locale JSON + sidebar defaultValue. Grey helpers default OFF. LICENSE still VSAL. Do not commit the scratch txt at repo root.
- **Verified 2026-08-20 (v0.16.1 cut):** `tsc -b` + `vite build` clean; jsdom smoke **76/76**; x64-release FileVersion **0.16.1.0**; ctest release **225/225** (6 live probes disabled/skipped). Version files in sync at **0.16.1**. Artifacts: MSI `VRCSM_v0.16.1_x64_Installer.msi` (9,183,232 bytes, SHA256 `4cb6bbd98a86de26cc6a170756e872de5f705cea40aebdff44fbd13cc114f443`), ZIP `VRCSM_v0.16.1_x64.zip` (21,629,413 bytes, SHA256 `bfecd60c62b811198f0ea8b84b4193439cbf68ec7b13a91386fcdcebebcb5780`). `SHA256:` line is required in GitHub release notes (updater fail-closed).
