...
- Current branch: `main`, **in sync with `origin/main`** (0 ahead / 0 behind) as of the v0.15.1 release. HEAD `88ef241` (release: sync vcpkg.json + complete 0.15.1 changelog).
