...
- **Verified 2026-08-21 (v0.16.3 cut):** `tsc -b` + `pnpm build` clean; x64-debug and x64-release ctest **239 passed / 0 failed** (1 skipped, 5 live DISABLED); Playwright `pnpm test:ui-smoke` **62/62** including `/migrate`. FileVersion **0.16.3.0**. Artifacts: MSI `VRCSM_v0.16.3_x64_Installer.msi` (9,633,792 bytes, SHA256 `8f3495c6c0ab3a4f0d6ec780699052a179e8cf23fb351a0ee0994bf7f6c02ced`), ZIP `VRCSM_v0.16.3_x64.zip` (12,814,756 bytes, SHA256 `9d0e11d8d712ca6ed53bc48843a7bf617f8ffdbe1f497be21ee21e20fe6d4795`). `SHA256:` line is required in GitHub release notes.
