...
[![Version](https://img.shields.io/badge/version-0.7.1-blue)](https://github.com/dwgx/VRCSM/releases/latest)
...
- **Steam Link 检测** 显示 HMD 序列号、音频设备列表
...
- `VRCSM_v0.7.1_x64_Installer.msi` — 推荐，标准 WiX 安装器
- `VRCSM_v0.7.1_x64.zip` — 解压即用，绿色版
...
- **Steam Link awareness** — HMD serial display and audio device enumeration
...
- `VRCSM_v0.7.1_x64_Installer.msi` — recommended, signed WiX installer
- `VRCSM_v0.7.1_x64.zip` — portable, run in place
...
- **Steam Link 検知** HMD シリアル表示とオーディオデバイス列挙
...
- `VRCSM_v0.7.1_x64_Installer.msi` — 推奨、WiX インストーラ
- `VRCSM_v0.7.1_x64.zip` — 解凍してそのまま実行可能
