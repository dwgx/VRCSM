...
- `VRCSM_v0.14.5_x64_Installer.msi` — 推荐，标准 WiX 安装器
- `VRCSM_v0.14.5_x64.zip` — 解压即用，绿色版
...
- `VRCSM_v0.14.5_x64_Installer.msi` — recommended, WiX installer
- `VRCSM_v0.14.5_x64.zip` — portable, run in place
...
- `VRCSM_v0.14.5_x64_Installer.msi` — 推奨、WiX インストーラ
- `VRCSM_v0.14.5_x64.zip` — 解凍してそのまま実行可能
