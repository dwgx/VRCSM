...
Last updated: 2026-06-29 (plan). **Status 2026-08-21:** Feed persistence + Hot Worlds shipped in 0.16.0. Friends Locations (FL1) + co-presence `world_visits` seed shipped in **0.16.3**. Mutuals are fetchOne (opt-in, no crawl). Remaining daily gaps: GH-CI, live graph proof, CacheIndex vs Bundles, FTS populate. Pack: `docs/SESSION-HANDOFF-2026-08-21.md`.
