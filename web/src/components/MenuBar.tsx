  ...
  const menus: MenuDef[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "go-groups", label: t("menu.goGroups", { defaultValue: "Groups" }), action: () => navigate("/groups") },
        { id: "go-profile", label: t("menu.goProfile"), action: () => navigate("/profile") },
        { id: "go-vrchat", label: t("menu.goVrchat"), action: () => navigate("/vrchat") },
        { kind: "separator", id: "go-sep-lab" },
        { id: "go-world-history", label: t("menu.goWorldHistory", { defaultValue: "World History" }), action: () => navigate("/history/worlds") },
        { id: "go-calendar", label: t("menu.goCalendar", { defaultValue: "Calendar & Jams" }), action: () => navigate("/calendar") },
        { id: "go-events", label: t("menu.goEvents", { defaultValue: "Event Recorder" }), action: () => navigate("/events") },
        { id: "go-social", label: t("menu.goSocial", { defaultValue: "Social Analytics" }), action: () => navigate("/social") },
        ...pluginGoItems,
      ],
    },
    {
      ...
      items: [
        ...
        { id: "tools-vrdiag", label: t("menu.toolsVrDiagnostics", { defaultValue: "VR Diagnostics" }), action: () => navigate("/settings?tab=vrdiag") },
        { kind: "separator", id: "tools-sep-lab" },
        { id: "tools-rules", label: t("menu.toolsRules", { defaultValue: "Automation Rules" }), action: () => navigate("/rules") },
        { id: "tools-osc", label: t("menu.toolsOsc", { defaultValue: "OSC Tools" }), action: () => navigate("/tools/osc") },
        { id: "tools-benchmark", label: t("menu.toolsBenchmark", { defaultValue: "Avatar Benchmark" }), action: () => navigate("/benchmark") },
        { id: "tools-fbt", label: t("menu.toolsFbt", { defaultValue: "FBT Monitor" }), action: () => navigate("/fbt") },
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "help-vrchat-status",
          label: t("menu.helpVrchatStatus", { defaultValue: "VRChat Status" }),
          action: () => void ipc.call("shell.openUrl", { url: "https://status.vrchat.com/" }),
        },
        {
          id: "help-vrchat-home",
          label: t("menu.helpVrchatHome", { defaultValue: "VRChat Home" }),
          action: () => void ipc.call("shell.openUrl", { url: "https://vrchat.com/home" }),
        },
        {
          id: "help-steam-link",
          label: t("menu.helpSteamLink", { defaultValue: "Steam Link for Meta Quest" }),
          action: () => void ipc.call("shell.openUrl", { url: "https://store.steampowered.com/steamlink/about" }),
        },
