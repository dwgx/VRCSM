...
export function TabConfigJson({ vrcRunning }: { vrcRunning: boolean }) {
  ...
  const configKeys = [
    ...
    { key: "cache_expiry_delay", type: "number", label: t("settings.configJson.cacheExpiryDelay.label", { defaultValue: "Cache Expiry Delay (seconds)" }), hint: t("settings.configJson.cacheExpiryDelay.hint", { defaultValue: "How long VRChat keeps unused cached assets before expiry. 0 uses the client default." }) },
